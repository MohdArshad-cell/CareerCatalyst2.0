        ...
        <div className="mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-zinc-950 border border-white/10 rounded-2xl p-4 hover:border-blue-500/50 transition-colors group">
              <div className="aspect-[1/1.29] relative bg-zinc-900 rounded-xl overflow-hidden mb-4">
                <img src="/resumes/elegant_preview.png" alt="Elegant Resume Template" className="object-cover w-full h-full opacity-80 group-hover:opacity-100 transition-opacity" />
              </div>
            ...
            <div className="bg-zinc-950 border border-white/10 rounded-2xl p-4 hover:border-blue-500/50 transition-colors group">
              <div className="aspect-[1/1.29] relative bg-zinc-900 rounded-xl overflow-hidden mb-4">
                <img src="/resumes/modern_line_preview.png" alt="Modern Line Resume Template" className="object-cover w-full h-full opacity-80 group-hover:opacity-100 transition-opacity" />
              </div>
            ...
            <div className="bg-zinc-950 border border-white/10 rounded-2xl p-4 hover:border-blue-500/50 transition-colors group">
              <div className="aspect-[1/1.29] relative bg-zinc-900 rounded-xl overflow-hidden mb-4">
                <img src="/resumes/one_column_preview.png" alt="One Column Resume Template" className="object-cover w-full h-full opacity-80 group-hover:opacity-100 transition-opacity" />
              </div>
            ...
            <div className="bg-zinc-950 border border-white/10 rounded-2xl p-4 hover:border-blue-500/50 transition-colors group">
              <div className="aspect-[1/1.29] relative bg-zinc-900 rounded-xl overflow-hidden mb-4">
                <img src="/resumes/professional_preview.png" alt="Professional Resume Template" className="object-cover w-full h-full opacity-80 group-hover:opacity-100 transition-opacity" />
              </div>
